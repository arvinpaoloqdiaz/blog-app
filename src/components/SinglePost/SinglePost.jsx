...
export default function SinglePost({ data, onDeleted }) {
  ...
  return (
    <div className={styles.singlePostCard}>
      <div className="d-flex justify-content-between flex-column flex-md-row gap-3 text-start">
        ...
        <div className={`d-flex flex-column text-start text-md-end ${styles.dates}`}>
          <span>
